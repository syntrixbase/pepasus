...
tools: "current_time, get_env, read_file, list_files, get_file_info, grep_files, http_get, web_search, json_parse, base64_decode, memory_list, memory_read, memory_write, memory_append, task_list, task_replay, notify"
---
